...
user = User.create(email: "test@test.com",password: "asdfasdf",password_confirmation: "asdfasdf", first_name: "Leo", last_name: "Garcia", maternal_surname: "Acosta",telephone:"1234567890")
